...
export const TaskInbox = () => {
    ...
    return (<div className="task-inbox">
            ...
            <div className="task-list">
                {activeTasks.length === 0 && completedTasks.length === 0 && (<div className="empty-state">
                        Inbox Zero (or disconnected). Try generating traffic!
                    </div>)}

                {activeTasks.map(task => (<div key={task.id} className="task-card">
