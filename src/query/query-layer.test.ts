...
describe('QueryLayer', () => {
  ...
  beforeEach(() => {
    ...
    constraintEngine = new ConstraintEngine(documentRegistry, holonRegistry, null as any);
    ...
    stateProjection = createStateProjectionEngine(eventStore, holonRegistry, relationshipRegistry);
